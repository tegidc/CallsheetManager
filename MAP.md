...
| **T-9** | **Notes** | Per-project scratchpad: rich-text notes (paragraphs, bold/italic, heading, bullet + numbered lists — 18 Sep 2026), newest first, searchable, autosaved (14 Sep 2026). No tags or attachments by design | `renderProjectNotes()` |
