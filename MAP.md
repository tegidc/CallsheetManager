...
| **T-10** | **Talent etc** | Talent and Client on a project, apart from Crew: day ticks, optional fee, their own hotel and travel per person, scoped add-person search | `renderProjectTalent()` |
